...
public class ScenariosTest {
    ...
    // 9. Create an abstract template for getting information about courses in higher education. Information to be collected should be course code and -name, how many credits the course is, the lecturer(s) in the course and information about what students will learn in a course.
    @Test
    public void scenario9(){

    }
    // 10. Create a template for scraping courses on hiof.no which extends the abstract template created in scenario 09.
    @Test
